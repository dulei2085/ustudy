...
public class RoleService {
	...
	public static void main(String[] args) {
		Role role = new Role(22 ,null, "123");
		RoleService service = new RoleService();
		service.list(role);
		service.findRoleByName("admin");
		service.findRoleById(1);
		service.deleteRoleByIds("123");
		service.insertRole(role);
		service.updateRole(role);
		service.getRoleByUserId(1);
		service.getRoleByUserName("admin");
	}
